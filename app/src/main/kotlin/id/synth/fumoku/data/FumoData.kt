...
val fumoData: Set<Pair<Fumo, FumoDetails>> = listOf(
    "Hakurei Reimu".let { character -> listOf(
        REGULAR.let { type -> listOf(
            fumo(
                character,
                type,
                "Version 1",
    ...
    "Kirisame Marisa".let { character -> listOf(
        REGULAR.let { type -> listOf(
            fumo(
                character,
                type,
